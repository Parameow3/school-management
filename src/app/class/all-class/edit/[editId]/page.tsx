...
const Page = () => {
  ...
  // Update handleBranchChange to accept a number and convert it to a string
  const handleBranchChange = (value: number) => {
    setFormData({
      ...formData,
      branch: value.toString(), // Convert number to string
    });
  };
  ...
  return (
    <div className="lg:ml-[16%] mt-20 ml-[11%] flex flex-col">
      ...
      <h1 className="text-center lg:text-2xl text-[15px] font-bold mb-8 mt-4 border-b-2">
        Update Class Form
      </h1>

      <div className="">
        <form onSubmit={handleUpdateClass} className="flex flex-col items-center space-y-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
            <div>
              ...
              <input
                ...
                className="mt-1 block lg:w-[272px] w-[329px] h-[40px] outline-none p-2 rounded-md border-gray-300 shadow-sm"
            ...
            <div>
              ...
              {/* Make sure Dropdown returns a number and handleBranchChange accepts a number */}
          ...
          <button type="submit" className="mt-4 px-4 py-2 bg-orange-600 text-white rounded-md shadow-sm hover:bg-orange-500">
            Update
          </button>
        </form>
      </div>
